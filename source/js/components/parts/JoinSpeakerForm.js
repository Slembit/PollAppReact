    ...
    render: function(){
        return(
           <form action="javascript:void(0)" onSubmit={this.nameEntered}>
                <label> Namn </label>
                <input type="text" placeholder="Ange ditt namn" ref="nameInput" required className='form-control'/>
                <label> presentation </label>
                <input type="text" placeholder="Ange namn på Presentationen" ref="titleInput" required className='form-control' />
